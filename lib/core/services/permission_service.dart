...
class PermissionService extends BaseService {
  ...
  Future<AllPermissionsResponse> getAllPermissions() async {
    return await executeRequest(
      () => get(AppConstants.allPermissionsEndpoint),
      (json) => AllPermissionsData.fromJson(json as Map<String, dynamic>),
    );
  }

  Future<StaffPermissionsResponse> getStaffPermissions() async {
    return await executeRequest(
      () => get(AppConstants.permissionsEndpoint),
      (json) => StaffPermissionsData.fromJson(json as Map<String, dynamic>),
    );
  }

  Future<void> cacheStaffPermissions(List<String> permissions) async {
    await secureStorage.write(
      key: AppConstants.staffPermissionsKey,
