  ...
  static void initialize() {
    router = GoRouter(
      ...
      routes: [
        ...
        GoRoute(path: '/orders/new', name: 'new-order', builder: (context, state) => const OrdersPage()),
        GoRoute(path: '/inventory', name: 'inventory', builder: (context, state) => const InventoryPage()),
